...
| 해야 할 일 | 다음 문서 |
|---|---|
| 시간 이력·저장·조회 원리 이해 | 핵심 개념 |
| 테이블 유형과 변경 정책 결정 | 테이블 타입 선택과 스키마 설계 |
| 센서·계측 이력 저장 | TAG 테이블 활용 |
| 이벤트와 로그 수집·검색 | LOG 테이블 활용 |
| 장기간의 태그 통계 조회 | TAG 테이블을 위한 ROLLUP 활용 |
| 기준 정보와 업무 데이터 관리 | LOOKUP, TRANSACTION |
| 다시 생성할 수 있는 상태 관리 | VOLATILE 테이블 활용 |
| 애플리케이션에서 입력·조회 | 개발 및 애플리케이션 연동 |
| SQL 문법과 타입 확인 | SQL 레퍼런스 |
| 운영·백업·권한 설정 | 운영, 설정, 복구, 계정과 권한 |
