...
먼저 테이블 타입 선택을 완료합니다. 이 페이지는 선택한
...
정확한 지원 범위와 구문은 ALTER TABLE 사전과
테이블 타입별 지원 범위를
참고하십시오.
...
VIEW 생성·조회·삭제와 제한은 VIEW SQL 사전을
참고하십시오.
