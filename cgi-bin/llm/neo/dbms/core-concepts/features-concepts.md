...
- **ROLLUP 통계의 역할** -- 반복 집계의 조회 비용을 줄이는 방법
- **Retention Policy의 역할** -- 기간에 따라 데이터를 자동 정리하는 방법
- **Backup·Restore·Mount의 관계** -- 보호, 복구, 조회 목적의 구분
...
자세한 생성 구문, 조회 함수, 재구성 절차는 TAG·ROLLUP 활용을
참고하십시오.
